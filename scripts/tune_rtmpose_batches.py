...
script calls ``scripts/run_cricket_rtmpose_inference.py`` repeatedly, reuses
...
INFERENCE_SCRIPT = ROOT / "scripts" / "run_cricket_rtmpose_inference.py"
...
def parse_args() -> argparse.Namespace:
    ...
    runtime.add_argument("--extra-args", nargs=argparse.REMAINDER,
                         help="Additional args passed to run_cricket_rtmpose_inference.py")

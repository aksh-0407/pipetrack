...
Jacobian of the pixel to ground map (perturb a pixel ±1 px, measure the ground displacement).
...
*Method:* image to ground homography `H = P[:, [0,1,3]]` (drop the z column), ground point
